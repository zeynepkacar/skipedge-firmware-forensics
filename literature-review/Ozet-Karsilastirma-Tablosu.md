...
| P09 | 2025 | Energy-Efficient Multi-LLM Reasoning for Zero-Day Detection | IoT firmware (binary-free) | Simülasyon / LLM muhakeme | Kod paylaşılmamış | Hayır | Evet | Hayır | Evet | Gerçek firmware'de test edilmemiş, simülasyon tabanlı | 3 |
| P10 |  2025 | PEMU (Protocol-Aware Firmware Rehosting) | Embedded ağ yığınları (network stacks) | Dinamik (protokol-farkında rehosting/fuzzing) | Kod açık (MPI-SysSec/pemu) | Hayır | Evet | Hayır | Hayır | Adli bilişim unsurları yok | 3 |
| P11 | 2026 | Out-of-Band Power Side-Channel Detection | Fiziksel donanım (yarı iletken) | Dinamik (güç tüketimi + GAN) | Kod paylaşılmamış | Hayır | Hayır | Hayır | Kısmen | Statik dosya analizi değil, farklı modalite | 2 |
