...
4. Takip tablosu (literatur-arac-sonuc-tablosu.xlsx) ChkUp'ın nihai durumuyla güncellendi. İki özet grafik üretildi: durum dağılımı (6 tam / 3 kısmi bulgu / 1 veri seti) ve araç başına çalışma süresi karşılaştırması (log ölçek). Bunlarla birlikte 3. hafta reproduction çalışması ve planlanan tüm adımlar (çaprazlama, tablo, grafikleştirme) tamamlandı.
5. Bildiri taslağı yazımına başlandı. Literatürdeki 10 makale dört kategoriye ayrılarak (analiz/keşif araçları; güncelleme ve davranışsal güvenlik; adli bilişim odaklı çalışmalar; tamamlayıcı araçlar) her birinin projeyle örtüşen, tamamlayıcı ve eksik yönleri tartışıldı; reproduction bulguları (ROSA'nın derleme başarısı, AutoFirm'in regex sınırlaması, FirmRCA'nın kök neden analizi, UEFI Memory Forensics'in imza doğrulaması, UniBOM'un SBOM+CVE sonucu, Pack-ALM'in forward pass doğrulaması, ChkUp'ta bulunan bug) ilgili makalelerin tartışmasına gerekçe olarak işlendi. Bu değerlendirme sonucunda projenin literatürdeki konumu netleştirildi: analist-tarafı, post-hoc, karşılaştırmalı bir adli bilişim yaklaşımı olarak, incelenen çalışmalar arasında doğrudan bir emsali bulunmayan bir boşluğu doldurduğu ortaya konuldu. Giriş ve İlgili Çalışmalar bölümleri bu çerçevede yazılıp Word belgesine aktarıldı; kalan bölümler (Yöntem, Sonuçlar, Tartışma, Sonuç, Kaynakça) iskelet halinde bırakıldı.
